...
import com.shatanshu.social_app.Home.MainActivity;
...
public class FirebaseMethods {
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                    mStorageReference.child(filePaths.FIREBASE_IMAGE_STORAGE + "/" + user_id + "/profile_photo" + (count + 1)).getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                        @Override
                        public void onComplete(@NonNull Task<Uri> task) {
                              setProfilePhoto(filePaths.FIREBASE_IMAGE_STORAGE);
                              ;
                        }
                    });
    ...
    private void addPhotoToDatabase(String caption, String url){
        Log.d(TAG, "addPhotoToDatabase: adding to database.");
